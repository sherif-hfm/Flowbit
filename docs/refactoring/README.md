...
**Status: Planned.** These documents describe future contributor work. Creating
the plans does not implement any of the refactors. The architecture and API
guides continue to describe the current application.

## Stages

| Stage | Deliverable | Dependency | Status |
| --- | --- | --- | --- |
| [1 — Instance list and search](stage-01-instance-queries.md) | A focused query service and repository port, with compatible engine forwarding methods. | Passing test baseline. | Planned |
