...
namespace Flowbit.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260825180852_HardenSharedVariablePersistence")]
    partial class HardenSharedVariablePersistence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flowbit.Infrastructure.Entities.SharedVariableWakeDeliveryEntity", b =>
                {
                    ...
                    b.HasIndex("TokenId", "ActivationId", "WakeId", "Id")
                    ...
                    b.ToTable("shared_variable_wake_deliveries", "flowbit", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_shared_variable_wake_deliveries_completion_shape", "(\"Status\" IN ('completed', 'cancelled') AND \"CompletedAt\" IS NOT NULL) OR (\"Status\" NOT IN ('completed', 'cancelled') AND \"CompletedAt\" IS NULL)");

                            t.HasCheckConstraint("CK_shared_variable_wake_deliveries_lease_shape", "(\"Status\" = 'leased' AND \"LeaseToken\" IS NOT NULL AND \"LeasedBy\" IS NOT NULL AND \"LeaseExpiresAt\" IS NOT NULL AND \"HeartbeatAt\" IS NOT NULL) OR (\"Status\" <> 'leased' AND \"LeaseToken\" IS NULL AND \"LeasedBy\" IS NULL AND \"LeaseExpiresAt\" IS NULL AND \"HeartbeatAt\" IS NULL)");

                            t.HasCheckConstraint("CK_shared_variable_wake_deliveries_max_attempts", "\"MaxAttempts\" > 0 AND \"AttemptCount\" <= \"MaxAttempts\"");

                            t.HasCheckConstraint("CK_shared_variable_wake_deliveries_status", "\"Status\" IN ('pending', 'leased', 'completed', 'failed', 'cancelled', 'incident')");
                        });
                });
            ...
            modelBuilder.Entity("Flowbit.Infrastructure.Entities.SharedVariableWakeEntity", b =>
                {
                    ...
                    b.Property<long>("ExpansionCursorTokenId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AvailableAt", "Revision", "Id")
                        .HasDatabaseName("IX_shared_variable_wakes_pending_available")
                        .HasFilter("\"Status\" = 'pending'");

                    b.HasIndex("LeaseExpiresAt", "Revision", "Id")
                        .HasDatabaseName("IX_shared_variable_wakes_expired_lease")
                        .HasFilter("\"Status\" = 'leased' AND \"LeaseExpiresAt\" IS NOT NULL");

                    b.HasIndex("RevisionId", "SharedVariableId", "Revision")
                        .IsUnique();
                    ...
                    b.ToTable("shared_variable_wakes", "flowbit", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_shared_variable_wakes_completion_shape", "(\"Status\" IN ('completed', 'cancelled') AND \"CompletedAt\" IS NOT NULL) OR (\"Status\" NOT IN ('completed', 'cancelled') AND \"CompletedAt\" IS NULL)");

                            t.HasCheckConstraint("CK_shared_variable_wakes_cursor", "\"ExpansionCursorTokenId\" >= 0");

                            t.HasCheckConstraint("CK_shared_variable_wakes_lease_shape", "(\"Status\" = 'leased' AND \"LeaseToken\" IS NOT NULL AND \"LeasedBy\" IS NOT NULL AND \"LeaseExpiresAt\" IS NOT NULL AND \"HeartbeatAt\" IS NOT NULL) OR (\"Status\" <> 'leased' AND \"LeaseToken\" IS NULL AND \"LeasedBy\" IS NULL AND \"LeaseExpiresAt\" IS NULL AND \"HeartbeatAt\" IS NULL)");

                            t.HasCheckConstraint("CK_shared_variable_wakes_max_attempts", "\"MaxAttempts\" > 0 AND \"AttemptCount\" <= \"MaxAttempts\"");

                            t.HasCheckConstraint("CK_shared_variable_wakes_status", "\"Status\" IN ('pending', 'leased', 'completed', 'failed', 'cancelled', 'incident')");
                        });
                });

            modelBuilder.Entity("Flowbit.Infrastructure.Entities.SharedVariableWakeIncidentEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("OriginalDeliveryId")
                        .HasColumnType("bigint");

                    b.Property<long>("OriginalWakeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("OriginalWakeId", "OriginalDeliveryId", "Id");

                    b.HasIndex("Status", "UpdatedAt", "Id");

                    b.ToTable("shared_variable_wake_incidents", "flowbit", t =>
                        {
                            t.HasCheckConstraint("CK_shared_variable_wake_incidents_resolution_shape", "(\"Status\" = 'open' AND \"ResolvedAt\" IS NULL AND \"ResolvedBy\" IS NULL AND \"ResolutionReason\" IS NULL) OR (\"Status\" = 'resolved' AND \"ResolvedAt\" IS NOT NULL AND \"ResolvedBy\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_shared_variable_wake_incidents_status", "\"Status\" IN ('open', 'resolved')");

                            t.HasCheckConstraint("CK_shared_variable_wake_incidents_target_shape", "(\"WorkKind\" = 'expansion' AND \"OriginalDeliveryId\" IS NULL AND \"DeliveryId\" IS NULL AND (\"Status\" <> 'open' OR \"WakeId\" IS NOT NULL)) OR (\"WorkKind\" = 'delivery' AND \"OriginalDeliveryId\" IS NOT NULL AND (\"Status\" <> 'open' OR \"DeliveryId\" IS NOT NULL))");

                            t.HasCheckConstraint("CK_shared_variable_wake_incidents_work_kind", "\"WorkKind\" IN ('expansion', 'delivery')");
                        });
                });
            ...
            modelBuilder.Entity("Flowbit.Infrastructure.Entities.SharedVariableWakeEntity", b =>
                {
                    ...
                    b.HasOne("Flowbit.Infrastructure.Entities.SharedVariableRevisionEntity", "RevisionRecord")
                        .WithOne("Wake")
                        .HasForeignKey("Flowbit.Infrastructure.Entities.SharedVariableWakeEntity", "RevisionId", "SharedVariableId", "Revision")
                        .HasPrincipalKey("Flowbit.Infrastructure.Entities.SharedVariableRevisionEntity", "Id", "SharedVariableId", "Revision")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Flowbit.Infrastructure.Entities.SharedVariableWakeIncidentEntity", b =>
                {
                    b.HasOne("Flowbit.Infrastructure.Entities.SharedVariableWakeDeliveryEntity", "Delivery")
                        .WithMany("Incidents")
                        .HasForeignKey("DeliveryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Flowbit.Infrastructure.Entities.SharedVariableEntity", "SharedVariable")
                        .WithMany("WakeIncidents")
                        .HasForeignKey("SharedVariableId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
